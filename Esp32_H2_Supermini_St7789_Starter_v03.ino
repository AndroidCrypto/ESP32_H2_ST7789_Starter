...
27.04.2025 V01 Initial programming
*/
...
const char *PROGRAM_VERSION = "ESP32-H2 Supermini ST7789 Starter V03";
const char *PROGRAM_VERSION_SHORT = "ST7789 Starter V03";
const char *DEVICE_NAME = "ESP32-H2 Supermini  2.0 in. 240 x 320 px";
const char *DIVIDER = "--------------------";
...
// -------------------------------------------------------------------------------
// Onboard LED
//#define ONBOARD_LED_PIN 13 // HIGH = LED on, LOW = LED off
